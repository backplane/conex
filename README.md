...
[kp1p](kp1p) | [`python:3-alpine`](https://hub.docker.com/_/alpine/)-based dockerization of kp1p, a utility for translating csv files exported from KeePassX/KeePassXC into a csv format that is better supported by 1Password. | [Dockerfile](kp1p/Dockerfile) | [galvanist/conex:kp1p](https://hub.docker.com/r/galvanist/conex/tags?name=kp1p)
