...
[ods_conv](ods_conv) | [`alpine:edge`](https://hub.docker.com/_/alpine/)-based utility which converts ODS documents into other formats (currently JSON and CSV) | [Dockerfile](ods_conv/Dockerfile) | [galvanist/conex:ods_conv](https://hub.docker.com/r/galvanist/conex/tags?name=ods_conv)
