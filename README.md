...
[chrome](chrome) | This is a [`debian:unstable-slim`](https://hub.docker.com/_/debian/)-based dockerization of Google Chrome for GNU/Linux. | [Dockerfile](chrome/Dockerfile) | [galvanist/conex:chrome](https://hub.docker.com/r/galvanist/conex/tags?name=chrome)
...
[firefox](firefox) | A [`debian:unstable-slim`](https://hub.docker.com/_/debian/)-based dockerization of the firefox web browser. | [Dockerfile](firefox/Dockerfile) | [galvanist/conex:firefox](https://hub.docker.com/r/galvanist/conex/tags?name=firefox)
