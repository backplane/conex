...
[kotlinc](kotlinc) | [`alpine:edge`](https://hub.docker.com/_/alpine/)-based dockerization of the kotlin compiler | [Dockerfile](kotlinc/Dockerfile) | [backplane/kotlinc](https://hub.docker.com/r/backplane/kotlinc)
