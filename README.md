...
[cdk](cdk) | [`alpine:edge`](https://hub.docker.com/_/alpine/)-based dockerization of [AWS CDK](https://aws.amazon.com/cdk/), the AWS Cloud Development Kit. | [Dockerfile](cdk/Dockerfile) | [backplane/cdk](https://hub.docker.com/r/backplane/cdk)
...
[yamllint](yamllint) | [`python:3.10-alpine`](https://hub.docker.com/_/python/)-based dockerization of [yamllint](https://yamllint.readthedocs.io/en/stable/index.html), the linter for YAML files. | [Dockerfile](yamllint/Dockerfile) | [backplane/yamllint](https://hub.docker.com/r/backplane/yamllint)
