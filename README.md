...
[ansible-runner](ansible-runner) | [`python:3-alpine`](https://hub.docker.com/_/alpine/)-based dockerization of [ansible-runner](https://ansible-runner.readthedocs.io). | [Dockerfile](ansible-runner/Dockerfile) | [backplane/ansible-runner](https://hub.docker.com/r/backplane/ansible-runner)
